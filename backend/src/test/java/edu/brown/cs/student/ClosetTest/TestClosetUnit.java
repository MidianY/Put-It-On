...
public class TestClosetUnit {
  ...
  /** Test to ensure that the closet can properly add clothing items that are properly named */
  @Test
  ...
  /** Test to ensure that incorrectly named items won't be added to the closet */
  @Test
